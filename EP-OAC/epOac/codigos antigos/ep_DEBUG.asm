.data
    arq_nome:     .asciiz "C:/Users/isacm/Downloads/ALAN/EP-OAC/epOac/Arquivos_de_numero/100numeros.txt"
    msg_ord:      .asciiz "\n\nELEMENTOS ORDENADOS\n\n"
    newline:      .asciiz "\n"
    ...
    # Mensagens de debug
    debug_abrindo:      .asciiz "[DEBUG] Abrindo arquivo...\n"
    debug_arquivo_ok:   .asciiz "[DEBUG] Arquivo aberto com sucesso. FD: "
    debug_contando:     .asciiz "[DEBUG] Contando linhas...\n"
    debug_linhas_total: .asciiz "[DEBUG] Total de linhas encontradas: "
    debug_alocando:     .asciiz "[DEBUG] Alocando memoria para array. Bytes: "
    debug_lendo_nums:   .asciiz "[DEBUG] Lendo numeros do arquivo...\n"
    debug_linha_lida:   .asciiz "[DEBUG] Linha lida: "
    debug_float_conv:   .asciiz "[DEBUG] Float convertido: "
    debug_array_pos:    .asciiz "[DEBUG] Armazenando na posicao: "
    debug_ordenando:    .asciiz "[DEBUG] Iniciando ordenacao...\n"
    debug_bubble:       .asciiz "[DEBUG] Usando Bubble Sort\n"
    debug_quick:        .asciiz "[DEBUG] Usando Quick Sort\n"
    debug_imprimindo:   .asciiz "[DEBUG] Imprimindo resultados...\n"
    debug_numero:       .asciiz "[DEBUG] Numero: "
    debug_posicao:      .asciiz " na posicao: "
    debug_fim:          .asciiz "[DEBUG] Programa finalizado.\n"
    debug_erro_arquivo: .asciiz "[DEBUG] ERRO ao abrir arquivo!\n"
    debug_particiona:   .asciiz "[DEBUG] Particionando de "
    debug_ate:          .asciiz " ate "
    debug_pivot_pos:    .asciiz "[DEBUG] Pivot na posicao: "
    debug_troca:        .asciiz "[DEBUG] Trocando posicoes "
    debug_e:            .asciiz " e "
    debug_parte_int:    .asciiz "[DEBUG] Parte inteira: "
    debug_parte_dec:    .asciiz "[DEBUG] Parte decimal: "
    debug_buffer:       .asciiz "[DEBUG] Buffer string: "
    debug_tam_str:      .asciiz "[DEBUG] Tamanho da string: "

.text
.globl main

main:
    # Debug: Abrindo arquivo
    li $v0, 4
    la $a0, debug_abrindo
    syscall
    ...
    slt $t0, $v0, $zero
    beq $t0, $zero, arquivo_ok
    
    # Debug: Erro ao abrir arquivo
    li $v0, 4
    la $a0, debug_erro_arquivo
    syscall
    j fim
...
arquivo_ok:
    ...
    # Debug: Arquivo aberto
    li $v0, 4
    la $a0, debug_arquivo_ok
    syscall
    ...
    # Debug: Contando linhas
    li $v0, 4
    la $a0, debug_contando
    syscall
...
fim_arq:
    # Debug: Total de linhas
    li $v0, 4
    la $a0, debug_linhas_total
    syscall
    ...
    # Debug: Alocando memoria
    addi $sp, $sp, -4
    sw $a0, 0($sp)
    
    li $v0, 4
    la $a0, debug_alocando
    syscall
...
le_nums:
    ...
    # Debug: Float convertido
    addi $sp, $sp, -4
    s.s $f0, 0($sp)
    
    li $v0, 4
    la $a0, debug_float_conv
    syscall
...
ordena_quick:
    ...
    # Debug: Pivot position
    li $v0, 4
    la $a0, debug_pivot_pos
    syscall
...
fim_conv:
    # Debug: Partes inteira e decimal
    addi $sp, $sp, -8
    sw $t1, 0($sp)
    sw $t2, 4($sp)
    
    li $v0, 4
    la $a0, debug_parte_int
    syscall
