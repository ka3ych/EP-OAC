.data
    ...
    tipo_ord:     .word 1            # 1 = bubble sort, 2 = quicksort
...
aplica_sinal:
    ...
    l.s $f1, flt_zero
    sub.s $f0, $f1, $f0    # Corrigido: $f0 = 0.0 - $f0
...
remove_zeros:
    ...
    div $t4, $t7
    mfhi $t1               # resto
    bne $t1, $zero, escrever_decimais # se resto != 0, para de remover
    mflo $t4               # quociente
